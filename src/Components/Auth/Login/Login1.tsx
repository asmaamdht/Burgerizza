...
export default function Login() {
  ...
  return (
    <>
      ...
      <div className="container_box min-vh-100 d-flex justify-content-center align-items-center">
        <div className="container p-0" style={{ maxHeight: "100vh" }}>


          <div className="row h-100">

            <div className="col-md-6 h-100 d-flex justify-content-end align-items-end " style={{background:"red"}}>
              <img
